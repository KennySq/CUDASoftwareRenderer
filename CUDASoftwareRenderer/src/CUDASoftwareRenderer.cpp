// CUDASoftwareRenderer.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//

#include "pch.h"
#include "framework.h"
#include "CUDASoftwareRenderer.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_CUDASOFTWARERENDERER, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_CUDASOFTWARERENDERER));

    MSG msg{};

    gEngine = std::make_unique<Engine>(hWnd);
